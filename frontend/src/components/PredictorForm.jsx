...
function PredictorForm() {
    ...
    return (
        <div className="card w-full max-w-md mx-auto bg-base-100/80 backdrop-blur-sm border border-base-content/5 shadow-2xl transition-all duration-300 hover:scale-[1.02]">
